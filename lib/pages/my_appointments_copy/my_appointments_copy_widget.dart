...
import 'my_appointments_copy_model.dart';
export 'my_appointments_copy_model.dart';

class MyAppointmentsCopyWidget extends StatefulWidget {
  const MyAppointmentsCopyWidget({super.key});

  @override
  _MyAppointmentsCopyWidgetState createState() =>
      _MyAppointmentsCopyWidgetState();
}

class _MyAppointmentsCopyWidgetState extends State<MyAppointmentsCopyWidget> {
  late MyAppointmentsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyAppointmentsCopyModel());
  }
