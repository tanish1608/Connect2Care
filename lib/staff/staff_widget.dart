                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 16.0, 0.0),
                                child: Text(
                                  'Manage the staff members in your hospital.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Manrope',
                          ...
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController2 ??=
                                  FormFieldController<String>(null),
                              options: const ['Hari', 'Victor', 'Malli', 'Deepika'],
                              onChanged: (val) =>
                          ...
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController3 ??=
                                  FormFieldController<String>(null),
                              options: const ['Peter', 'Steve', 'Mike', 'Ella'],
                              onChanged: (val) =>
                          ...
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller: _model.dropDownValueController4 ??=
                                  FormFieldController<String>(null),
                              options: const ['Rohi', 'Lokesh', 'Shravan', 'Vinod'],
                              onChanged: (val) =>
