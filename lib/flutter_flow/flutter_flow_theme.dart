...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color grayLight = const Color(0xFFCDCACA);
  late Color textColor = const Color(0xFF070606);
  late Color background = const Color(0xFFEDEDED);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color grayLight = const Color(0xFFE2DFD7);
  late Color textColor = const Color(0xFFF8F7F7);
  late Color background = const Color(0xFF070606);
}
